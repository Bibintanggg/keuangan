        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white rounded-lg shadow overflow-x-auto">
                <table class="min-w-[640px] w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($expenses as $expense)
                            <tr>
                                <td class="px-4 py-3 whitespace-nowrap">Rp {{ number_format($expense->total, 0, ',', '.') }}</td>
                                <td class="px-4 py-3 whitespace-nowrap">{{ $expense->deskripsi ?? '-' }}</td>
                                <td class="px-4 py-3 whitespace-nowrap">{{ $expense->transaction_date->format('d M Y') }}</td>
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <a href="{{ route('expense.edit', $expense->id) }}" class="text-yellow-500 hover:underline">Edit</a>
                ...
                <div class="flex gap-5 items-center">
                    ...
                    <a href="{{ route('expense.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded mb-4 inline-block mt-10">+ Tambah Pengeluaranmu</a>
